...
class TBS:
    def __init__(self,root):
        ...
        blank_space =" "
        self.root.title(150*blank_space+"BVCOENM Billing and Management System |  Developed by SE student")
        self.root.config(bg="white")

        #title
        self.icon_title=PhotoImage(file="images/tool.png")
        title = Label(self.root,text="BVCOENM Billing Tool",image=self.icon_title,compound=LEFT,font=("ARIEL",40,"bold"),bg="#722F37",fg="white", anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=120)
        ...
        #clock
        self.lbl_clock = Label(self.root,text="Welcome To BVCOENM...!!\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("ARIEL",14),bg="white",fg="black",borderwidth=3, relief="solid")
        ...
        # btn_most = Button(LeftMenu,text="Most Selling",command=self.mostsale,image=self.icon_side,compound=LEFT,padx=20,anchor="w",font=("ARIEL",10,"bold"),bg="white",bd=3,cursor="hand2").place(x=30,y=460,height=40,width=150)
        ...
        self.lbl_employee.place(x=350,y=170,height=100,width=200)

        self.lbl_supplier = Label(self.root,text="Suppliers\n[ 0 ]",bd=5,relief=RIDGE,bg="#722F37",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_supplier.place(x=900,y=170,height=100,width=200)
        ...
        self.lbl_mostsale= Label(self.root,text="Most Selling Products\n[ 0 ]",bd=5,relief=RIDGE,bg="#722F37",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_mostsale.place(x=350,y=550,height=100,width=300)

        

        #footer
        lbl_footer = Label(self.root,text="BVCOENM Billing and Management System |  Developed by SE student\nFor any technical issues Contact: +91-8111833958",font=("ARIEL",8),bg="#722F37",fg="white",borderwidth=1, relief="solid")
    ...
    def update_content(self):
        ...
        try:
            ...
            cur.execute("select min(qty),itemname from stock")
            stock=cur.fetchall()
            self.lbl_mostsale.config(text=f'Most Selling Prodcts\n[ {str({len(stock)})} ]')
            ...
            self.lbl_clock.config(text=f"Welcome To BVCOENM...!!\t\t Date: {str(date_)}\t\t Time: {str(time_)}" )
