...
class billClass:
    def __init__(self,root):
        ...
        blank_space =" "
        self.root.title(150*blank_space+"BVCOENM Developed By SE Students")
        ...
        title = Label(self.root,text="Billing Tool",image=self.icon_title,compound=LEFT,font=("ARIEL",40,"bold"),bg="#722F37",fg="white", anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=120)
        ...
        #clock
        self.lbl_clock = Label(self.root,text="Welcome To Billing Tool...!!\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("ARIEL",8),bg="white",fg="black",borderwidth=3, relief="solid")
...
###Customer Frame
        ...
        CartFrame.place(x=20,y=2,width=490,height=300)
    ...
    #-------------------billing buttons
        ...
        btn_generate_bill=Button(billMenuFrame,text='Generate Bill',command=self.generate_bill,font=("goudy old style",15,"bold"),bg="#722F37",fg="white",cursor="hand2")
...
Total Invoice Amount(A+B)\t\t\tRs.{self.total_invoice_amount} 
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Welcome To BVCOENM Billing...!!\t\t Date: {str(date_)}\t\t Time: {str(time_)}" )
